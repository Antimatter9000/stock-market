...
export default {
    ...
    "percentage of gap": (_, highestPrice, lowestPrice, stock) => {
        console.log('h:', highestPrice, 'l:', lowestPrice);
        const gap = highestPrice - lowestPrice === 0 ? 1 : highestPrice - lowestPrice;
        console.log('confidence =', (((highestPrice - stock.price)/gap) * 200))
        return (((highestPrice - stock.price)/gap) * 200);
    }
}